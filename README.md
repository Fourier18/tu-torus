...
Download `Tu-Torus.Setup.1.0.3.exe` from [the latest release](https://github.com/Fourier18/tu-torus/releases/latest) and run it.
...
Builds `dist/Tu-Torus Setup 1.0.3.exe`.
